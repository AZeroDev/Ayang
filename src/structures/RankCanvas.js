    ...
    async build() {
        ...
        canvas.setGlobalAlpha(0.5)
            ...
            .process(canvas =>
                ...
                // Xp
                .setTextAlign("right")
                .printText("XP:", width - 40, 210)
                .printText(this.data.xp.current.toString(), width - canvas.measureText("XP:").width - 5, 210)
                .printText("/", width - canvas.measureText("XP: "+this.data.xp.current).width - 5, 210)
